...
84 bytes from 1.1.1.1 icmp_seq=1 ttl=59 time=22.809 ms
84 bytes from 1.1.1.1 icmp_seq=2 ttl=59 time=20.477 ms
84 bytes from 1.1.1.1 icmp_seq=3 ttl=59 time=19.022 ms
84 bytes from 1.1.1.1 icmp_seq=4 ttl=59 time=13.299 ms
84 bytes from 1.1.1.1 icmp_seq=5 ttl=59 time=15.685 ms
```
...
```
root@localhost arthur]# curl web.tp3.b2 | head
<!doctype html>
<head>
...
[root@localhost arthur]# curl supersite.tp3.b2 | head
<!doctype html>
<head>
<meta name='viewport" content='width=device-width, initial-scale=1'>
<title>HTTP Server Test Page powered by: Rocky Linux</title>
